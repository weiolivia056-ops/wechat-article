...
```yaml
description: 微信公众号文章抓取与处理工具。本技能应在用户需要获取、解析或转换微信公众号文章内容时使用。
```
...
| 版本 | 日期 | 更新内容 |
| :----- | :--------- | :------------------------------------------------------- |
| v1.0.0 | 2026-02-09 | 初始版本，基于 legal-skills 项目的 SKILL-GUIDE.md 适配 wechat-article 项目 |
