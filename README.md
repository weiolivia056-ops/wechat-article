...
| 技能                                                                | 说明                                                                                                                                                                        | 许可证        | 版本   | 作者       |
| :------------------------------------------------------------------ | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :------------ | :----- | :--------- |
| **[privacy-gap-analysis](skills/privacy-gap-analysis/)**         | 网站数据隐私合规差距分析工具（Wise DPO 平台产品）。输入域名即可自动爬取并分析网站的隐私政策、用户协议、Cookie 与用户交互界面，按 GDPR/ePrivacy/DSA 或 CCPA/CPRA 框架生成结构化 HTML 差距报告，含雷达图风险评分和整改建议 | CC-BY-NC-SA-4.0 | v1.0.0 | 杨卫薪律师 |
